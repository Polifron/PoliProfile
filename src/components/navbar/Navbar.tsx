...
export default function Navbar({ navItems, isMobileMenuOpen, setIsMobileMenuOpen }) {
  ...
  return (
    <header className="absolute inset-x-0 top-0 z-40">
      <nav className="flex w-full items-center justify-between border-b border-black/10 bg-white/45 px-3 py-3 shadow-sm backdrop-blur-md dark:border-white/15 dark:bg-black/45 sm:px-4">
